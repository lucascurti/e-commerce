						...
						{cart.products.map((product, index) =>
							(
								<tr key={product.id}>
									<td data-th="Product">
										<div className="row">
											<div className="col-sm-2 hidden-xs"><img src={product.image} alt="..." className="img-responsive" style={{ width: '100px' }} /></div>
									...
									<td data-th="Quantity">
										<input type="number" className="form-control text-center" value={product.orderDetail.amount} onChange={(e) => changeAmount(Number(e.target.value), index)} id='amount' />
									</td>
									<td data-th="Subtotal" className="text-center">{product.orderDetail.price * product.orderDetail.amount}</td>
